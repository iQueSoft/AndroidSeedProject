...
public class ScrollingGalleryFragmentTest {
    ...
    public void setUp() throws Exception {
        ...
        activityTestRule.getActivity().getSupportFragmentManager().beginTransaction().add(R.id.fragmentContainer, new ScrollingGalleryFragment(), null).commit();
    }
